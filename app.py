...
# Antibiotic list analyzed as of 2024-03-26
...
app_ui = ui.page_fluid(
    ...
    ui.p(ui.tags.em('For illustation purposes only. Inputs are randomized and outputs are therefore meaningless.')),
        ...
        ui.sidebar(
            ...
            ui.card(
                ui.input_radio_buttons('Hospital','Hospital:',
                                      ['Hospital X','Hospital Y','Hospital Z'],inline=True)
            ),
            ...
            ui.card(
                ...
                ui.tooltip(
                    ...
                    'Sex in EMR at time of index culture collection'
                )
            ),
            ...
            ui.card(
                ...
                ui.tooltip(
                    ...
                    'Hospitalization within 90 days prior to index culture collection date'
                ),
                ui.tooltip(
            ...
            ui.tooltip(
                ...
                'Antibiotic exposure in the last 90 days to 48 hours prior to the time of index culture order.'
            ),
